...
vector<Scenario> BuildScenarios() {
	return {
		...
		{3, 0.1, 0.1, Stochastic::DistributionTypes::DIST_FB_CF, 2000.0, BuildTopologyCOGENT()},
		{3, 0.2, 0.1, Stochastic::DistributionTypes::DIST_FB_CF, 2000.0, BuildTopologyCOGENT()},
		{3, 0.3, 0.1, Stochastic::DistributionTypes::DIST_FB_CF, 2000.0, BuildTopologyCOGENT()},
		{3, 0.4, 0.1, Stochastic::DistributionTypes::DIST_FB_CF, 2000.0, BuildTopologyCOGENT()},
		{3, 0.5, 0.1, Stochastic::DistributionTypes::DIST_FB_CF, 2000.0, BuildTopologyCOGENT()},
